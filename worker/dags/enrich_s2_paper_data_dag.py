...
Responsibilities:
- Query papers needing S2 enrichment (arxiv_id present, s2_ids NULL)
...
- Mark unmatched papers with s2_ids = {} so they are excluded from future queries
"""
...
def fetch_papers_needing_s2_data(exclude_ids: List[str] = None) -> List[Tuple[int, str]]:
    """
    Query papers that have an arxiv_id but no S2 data yet.
