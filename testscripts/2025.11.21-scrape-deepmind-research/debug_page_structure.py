#!/usr/bin/env python3
"""
Debug script to inspect the structure of a DeepMind publication page.
"""
...
def inspect_publication_page(url: str):
    ...
    try:
        ...
        patterns = [
            ...
            ("Links with 'read' text", None),  # Custom search
        ]
...
if __name__ == "__main__":
    # Test with one of the publications
    test_url = "https://deepmind.google/research/publications/a-pragmatic-view-of-ai-personhood/"

    print("DeepMind Publication Page Inspector")
    print("=" * 80)
