...
export default function SharedPaperClient({ initialPaperData, slug }: SharedPaperClientProps) {
    ...
    try {
      ...
      setPapers(prev => {
        ...
        const newPapers = result.items.filter(
          p => !existingIds.has(p.paper_uuid) && p.paper_uuid !== initialPaperData.paper_id
        );
  ...
  }, [isLoading, initialPaperData.paper_id, paperSummaries, loadingSummaries]); // eslint-disable-line react-hooks/exhaustive-deps
          ...
          <div className="bg-white dark:bg-gray-800 border-2 border-blue-500 dark:border-blue-400 rounded-lg shadow-lg">
            ...
            <div className="p-4">
              <div className="flex items-start gap-4 mb-4">
                {initialPaperData.thumbnail_url && (
                  <img
                    src={initialPaperData.thumbnail_url}
                    alt=""
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {initialPaperData.arxiv_url && (
                    <a
                      href={initialPaperData.arxiv_url}
                      target="_blank"
              ...
              {/* Five minute summary */}
              {initialPaperData.five_minute_summary && (
                <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="prose prose-sm dark:prose-invert max-w-none">
                    ...
                    >
                      {preprocessBacktickedMath(initialPaperData.five_minute_summary)}
                    </ReactMarkdown>
                  </div>

                  {/* Action buttons - bottom right corner */}
                  <div className="mt-4 flex items-center justify-end gap-2">
                    <CopyMarkdownButton paperUuid={initialPaperData.paper_id} fiveMinuteSummary={initialPaperData.five_minute_summary} />
                    <AddToListButtonMobile paperId={initialPaperData.paper_id} paperTitle={initialPaperData.title || undefined} />
                    <button
                      onClick={handleShare}
